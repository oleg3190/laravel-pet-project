...
use App\Http\Controllers\Fake\UserFakeController;
...
|
*/
Route::get('/users', [UserFakeController::class, 'createUsers']);
Route::get('/users-get', [UserFakeController::class, 'getByNameAge']);
Route::get('/', function () {


	dd(DB::select("SELECT count(*) from users")[0]);
});
